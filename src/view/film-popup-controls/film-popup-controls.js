...
export default class FilmPopupControls extends AbstractView {
  ...
  setAddToHistoryClickHandler(callback) {
    ...
    this.element.querySelector(`#watched`).addEventListener(`click`, this._addToHistoryClickHandler);
  }
  ...
  setAddToWatchListClickHandler(callback) {
    ...
    this.element.querySelector(`#watchlist`).addEventListener(`click`, this._addToWatchListClickHandler);
  }
